...
#ifndef FROMMLE_D2GEOCOPERATOR_HPP
#define FROMMLE_D2GEOCOPERATOR_HPP
namespace frommle{
    namespace sh{

        //@brief extracts geocenter motion in cartesian coordinates from a set of fully normalized geopotential cifficients (Note  that all coefficients which degrees other than 1 will be unused
        class Deg1ToGeocXYZ:public core::GOperatorDyn<double,1,1>{
            public:
                using GOp=core::GOperatorDyn<double,1,1>;
                Deg1ToGeocXYZ():GOp(){}
